...
import { RCheckboxModule } from './checkbox.module';
import { RIconModule } from '../../icon/icon.module';

describe('Component: RCheckbox', () => {

  let checkbox: RCheckboxComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ RCheckboxModule, RIconModule, RCheckboxModule],
    });
...
@Component({
  template: `<r-checkbox [formControl]="formControl"></r-checkbox>`,
})
class CheckboxWithFormControlComponent {
  formControl = new FormControl();
}

describe('Component: RCheckbox with form control', () => {

  let fixture: ComponentFixture<CheckboxWithFormControlComponent>;
  let checkboxComponent: DebugElement;
  let checkboxInstance: RCheckboxComponent;
  let testComponent: CheckboxWithFormControlComponent;
  let inputElement: HTMLInputElement;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, RIconModule, RCheckboxModule],
      declarations: [RCheckboxComponent, CheckboxWithFormControlComponent],
    });
      ...
      checkboxComponent = fixture.debugElement.query(
        By.directive(RCheckboxComponent),
      );
