...
describe('icons-library', () => {
  ...
  it('should register RSvgIcon svg icon', () => {

    iconsLibrary.registerSvgPack('super-pack', {
      home: new RSvgIcon('home', '<svg><rect></rect></svg>', { packClass: 'sp' }),
    });
    iconsLibrary.setDefaultPack('super-pack');
  ...
  it('should register custom svg icon', () => {
    ...
    class CustomSvgIcon extends RSvgIcon {
      getContent() {
          return 'custom';
      }
    }
